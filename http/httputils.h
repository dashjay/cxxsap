...
#ifndef HTTP_TEST_HTTPUTILS_H
#define HTTP_TEST_HTTPUTILS_H
...
namespace http::httputil {
    ...
    void parse_request_line(http_request &r, std::string line);

    void parse_reesponse_line(http_response &r, std::string line);
